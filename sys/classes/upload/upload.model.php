                ...
                $thumb->quality=$quality;                  //default 75 , only for JPG format
                 if($thumb->img['x_thumb']<=$src_x AND $thumb->img['y_thumb']<=$src_y){
                    if($src_x/$thumb->img['x_thumb'] >= $src_y/$thumb->img['y_thumb']){
                        $thumb->img['y_thumb'] = $src_y*$thumb->img ['x_thumb']/$src_x;
                        $height = $src_y*$thumb->img ['x_thumb']/$src_x;
                    }else{
                        $thumb->img['x_thumb'] = $src_x*$thumb->img ['y_thumb']/$src_y;
                        $width = $src_x*$thumb->img ['y_thumb']/$src_y;
                    }
                }else{
                    if($thumb->img['x_thumb']>=$src_x AND $thumb->img['y_thumb']<=$src_y){
