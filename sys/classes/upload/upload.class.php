...
// Change Request Nbr:
// ================================================================================================ 
    function ShowListOfFilesFrontend($array, $position,$lang = _LANG_ID, $first = false){

            UploadView::ListFilesFrontendLast($lang,$array,$this->path.'/'.$position, $this->multi_lang);
