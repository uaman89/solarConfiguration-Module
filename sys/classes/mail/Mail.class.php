...
include_once( SITE_PATH.'/sys/classes/mail/class.phpmailer.php' );
...
$mail->Host     = "mail.seotm.kiev.ua";             // SMTP servers
$mail->SMTPAuth = true;                            // turn on SMTP authentication
$mail->Username = "sendy@seotm.kiev.ua";                        // SMTP username
$mail->Password = "";                   // SMTP password
$mail->From     = "sendy@seotm.kiev.ua";
$mail->FromName = "Andriy Lykhodid";
$mail->AddAddress("info@seotm.com","Andiy Lykhodyd");
$mail->AddReplyTo("igor@seotm.com","Andiy Lykhodyd");
