...
$href = AntiHacker::AntiHackArrayRequest('href');
...
if (!isset($_REQUEST['replace_to']))
    ...
    $replace_to = stripslashes(trim($_REQUEST['replace_to']));
...
$usevisible = AntiHacker::AntiHackRequest('usevisible', '0');
$usehref = AntiHacker::AntiHackRequest('usehref', '0');
$useuploadimages = AntiHacker::AntiHackRequest('useuploadimages', '0');
$useuploadfiles = AntiHacker::AntiHackRequest('useuploadfiles', '0');
...
if ($module != NULL) {
    ...
    $sys_spr->usehref = $usehref;
    $sys_spr->useuploadimages = $useuploadimages;
    $sys_spr->useuploadfiles = $useuploadfiles;
    $sys_spr->usevisible = $usevisible;
