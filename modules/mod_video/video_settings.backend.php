<?php                                     /* video_settings.backend.php */
// ================================================================================================
// System : SEOCMS
// Module : video_settings.backend.php
// Version : 1.0.0
// Date : 01.07.2010
// Licensed To:Yaroslav Gyryn 
// Purpose : script for all actions with settings for video on the back-end
// ================================================================================================
if (!defined("SITE_PATH")) define( "SITE_PATH", $_SERVER['DOCUMENT_ROOT'] );
include_once( SITE_PATH.'/admin/include/defines.inc.php' );
include_once( $_SERVER['DOCUMENT_ROOT'].'/modules/mod_video/video.defines.php' );
...
else $img_path = 'uploads/images/video';
...
$Art = new Video_settings($logon->user_id, $module,NULL,NULL,NULL,"500");
$Art->img = $img; 
