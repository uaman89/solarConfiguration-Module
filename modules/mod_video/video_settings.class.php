...
// ================================================================================================
// System : SEOCMS
// Module : video_settings.class.php
// Version : 1.0.0
// Date : 01.07.2010
// Licensed To:
...
//
// Purpose : Class definition for all actions with settings of Video
//
// ================================================================================================
...
//    Returns           : None
//    Description       : Class definition for all actions with managment of Video
// ================================================================================================
...
// ================================================================================================
 class Video_settings extends Video {
    var $set_keywrd;
    var $set_descr;
    var $rss;

    // ================================================================================================
    //    Function          : Video_settings (Constructor)
    //    Version           : 1.0.0
    //    Date              : 01.07.2010
    ...
    // Description : show setting of Videoue
    // ================================================================================================
    ...
    $script = $_SERVER['PHP_SELF'].'?module='.$this->module;
     ...
     $row = $this->Right->db_FetchAssoc();
      $q1="select * from `".TblModVideoSetSprMeta."` where 1";
...
<?}?>
    ...
    else
    {
      ...
      $q="insert into `".TblModVideoSet."` values('$this->img', '$this->set_keywrd', '$this->set_descr', '$this->rewrite', '$this->dt', '$this->img_path', '$this->rss')";
      $res = $this->Right->Query( $q, $this->user_id, $this->module );
      //echo '<br>q='.$q.' res='.$res.' $this->Right->result='.$this->Right->result;
      if( !$this->Right->result) return false;
    }
////////////////////////////////////////////////////////////
    $q="select * from `".TblModVideoSetSprMeta."` where 1";
    $res = $this->Right->Query( $q, $this->user_id, $this->module );
    if( !$this->Right->result ) return false;
    $rows = $this->Right->db_GetNumRows();
    $meta= array();
     ...
     $ln_sys = new SysLang();
            ...
            while( $el = each( $ln_arr ) )
            {
              ...
              if (isset($meta[$lang_id]))
              {
                 ...
                 $q="update `".TblModVideoSetSprMeta."` set
...
//                  echo '<br>q='.$q.' res='.$res.' $this->Right->result='.$this->Right->result;
        ...
        {
          $q="insert into `".TblModVideoSetSprMeta."`  set
                  `title`='".$this->title[$lang_id]."',
                  `description`='".$this->description[$lang_id]."',
                  `keywords`='".$this->keywords[$lang_id]."',
                  `lang_id`='$lang_id'";
