...
if (!defined("ARTICLE_MAX_IMAGE_WIDTH"))
    define("ARTICLE_MAX_IMAGE_WIDTH", "2024");
if (!defined("ARTICLE_MAX_IMAGE_HEIGHT"))
    define("ARTICLE_MAX_IMAGE_HEIGHT", "2024");
if (!defined("ARTICLE_MAX_IMAGE_SIZE"))
    define("ARTICLE_MAX_IMAGE_SIZE", 2048 * 1024);
if (!defined("ARTICLE_WATERMARK_TEXT"))
    define("ARTICLE_WATERMARK_TEXT", "seotm.com");
if (!defined("ARTICLE_ADDITIONAL_FILES_TEXT"))
    define("ARTICLE_ADDITIONAL_FILES_TEXT", "_autozoom_");
if (!defined("ARTICLE_MAX_IMAGES_QUANTITY"))
    define("ARTICLE_MAX_IMAGES_QUANTITY", "85");
?>